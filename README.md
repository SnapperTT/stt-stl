...
* `stt::setDefaultAllocator(...)`, `stt::getDefaultAllocator()`: Pointer to the global shared default allocator - if an allocator is not defined for an object then this will be used
