...
{
  template <unsigned int USZ>
  constexpr void * unboundedPageI <USZ>::ptr ()
                                                       { return &_data[STT_PAGE_HEADER_SIZE]; }
}
namespace stt
{
  template <unsigned int USZ>
  constexpr void const * unboundedPageI <USZ>::ptr () const
                                                       { return &_data[STT_PAGE_HEADER_SIZE]; }
}
namespace stt
{
  template <unsigned int USZ>
  constexpr size_t unboundedPageI <USZ>::capacity ()
...
namespace stt
{
  ...
  void pageQueueImpl <T, P>::push_back (T const & t)
			...
			if (p.ph.localSize >= localCapacity()) {
				// page is full!
				pageQueueImpl* PN = NULL;//p.ph.allocator.allocatePage();
				PN->p.ph.next = (pageHeader*) this;
